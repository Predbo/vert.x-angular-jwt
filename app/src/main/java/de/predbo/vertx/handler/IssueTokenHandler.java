...
public class IssueTokenHandler implements Handler<RoutingContext> {

	private static final Logger _logger = LoggerFactory.getLogger(IssueTokenHandler.class);
	
	private JWTAuth _jwtAuthProvider;
	private UserRegistry _userRegistry;

	public IssueTokenHandler(JWTAuth jwtAuthProvider, UserRegistry userRegistry) {
