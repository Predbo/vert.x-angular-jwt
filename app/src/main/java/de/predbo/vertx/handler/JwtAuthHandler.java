...
public class JwtAuthHandler extends AuthHandlerImpl implements Handler<RoutingContext> {

	private static final Logger _logger = LoggerFactory.getLogger(JwtAuthHandler.class);
